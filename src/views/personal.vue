...
export default {
  ...
  data() {
        return{
            ...
            checkboxValue: false,
            empty_message: "No tasks for your personal stuff to do today yet...Have a nice day..:)",
        }
  },
  async beforeMount(){
    try{
        const res = await axios.get('http://localhost:3000/category/personal' )
  ...
  methods: {
        ...
        async DeleteFromList(id){
            ...
            if(!this.show_all_button){
                  ...
                  const res = await axios.get('http://localhost:3000/all/personal')
                  this.list = res.data.rows
              }
        },
        getDate: function(){
        ...
        async show_all(){
            if(!this.show_all_button){
                const result = await axios.get('http://localhost:3000/all/personal')
                ...
                let url = 'http://localhost:3000/category/personal'
